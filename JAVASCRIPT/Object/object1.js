...
//  function cake(name,cprice){
//     this.cakeName=name;
//     this.cake_Price=cprice;
// }
// let c1=new cake("Chocolate Cake",500);
// console.log(c1);
// let c2=new cake("Vanilla Cake",400);
// console.log(c2);
// let c3=new cake("Red Velvet Cake",600);
// console.log(c3);

// !----math-----
// let a=Math.PI //!---1
// let a=Math.floor(20.9)  //!---2
// let a=Math.ceil(20.1)   //!---3
// let a=Math.round(20.5)   //!---4
// let a=Math.sqrt(16)         //!---5
// let a=Math.pow(2,3)        //!---6
// let a=Math.min(10,5,20,3)   //!---7
// let a=Math.max(10,5,20,3)   //!---8
// let a=Math.random()          //!---9   
// let a=Math.random()*100      //!---10   
// let a=Math.floor(Math.random()*100)  //!---11  
// let a=Math.floor(Math.random()*100)+1  //!---12
// let a=Math.floor(Math.random()*50)+50  //!---13
// let a=Math.floor(Math.random()*51)+50  //!---14
// let a=Math.floor(Math.random()*26)+65  //!---15
// let a=Math.cbrt(27)  //!---16
// console.log(a);
